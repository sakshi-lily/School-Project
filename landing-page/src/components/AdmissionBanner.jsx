          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-8 w-full sm:w-auto">
                <a
                  href="#quick-services"
                  className="w-full sm:w-auto bg-secondary hover:bg-secondary-light text-primary font-heading font-extrabold px-8 py-4 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-secondary/20 flex items-center justify-center gap-2 transform hover:-translate-y-1 active:translate-y-0"
                >
