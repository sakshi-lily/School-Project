...
const Gallery = () => {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      title: "Independence Day Parade March",
    ...
    },
    {
      ...
      title: "Saraswati Vandana Cultural Dance",
    ...
    },
    {
      ...
      title: "Science Exhibition Physics Working Models",
      category: "Science Exhibition",
      span: "md:col-span-1"
    },
    {
      ...
      title: "Group Song Performance - Cultural Fest",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-extrabold text-slate-900 mt-4 leading-tight">
            Our Campus & Event Gallery
          </h2>
          <p className="text-slate-500 text-sm md:text-base mt-3">
            Explore glimpses of celebrations, sporting milestones, labs and day-to-day academic life at Thakur Biri Singh Inter College.
          </p>
        </div>
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-16 bg-white rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center">
            ...
            <h3 className="font-heading font-bold text-slate-600 text-lg">No Images Available</h3>
            <p className="text-slate-400 text-sm mt-1">We are currently compiling photos for this category. Check back soon!</p>
          </div>
        )}
